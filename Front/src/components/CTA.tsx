  ...
  return (
    <section className="bg-surface py-32 px-8">
      ...
      >
        ...
        <h2 className="text-5xl md:text-6xl font-bold text-white mb-8 tracking-tight">Show the product honestly.</h2>
        <p className="text-on-surface-variant text-xl max-w-2xl mx-auto mb-12 leading-relaxed">
          Lead with webhook ingest, connector setup, analyst-reviewed response, and the rollout path from demo mode to enterprise mode.
        </p>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6">
          ...
          <a href="/features" className="px-12 py-5 rounded-2xl border border-outline text-white font-bold text-xl hover:bg-white/5 transition-all transform hover:scale-105 no-underline">
            See Use Cases
          </a>
        </div>
      </motion.div>
